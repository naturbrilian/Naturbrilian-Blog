...
export const siteConfig: SiteConfig = {
  title: 'Natur Brilian',
  subtitle: 'Blog and Site',
  lang: 'en',         // 'en', 'zh_CN', 'zh_TW', 'ja', 'ko', 'es', 'th', 'id'
  themeColor: {
...
export const navBarConfig: NavBarConfig = {
  links: [
    ...
    {
      name: 'Portofolio',
      url: 'https://foriio.com/naturbrilian',     // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
  ...
  links: [
    ...
    },
    {
      ...
      url: 'https://steamcommunity.com/id/naturbrilian',
    },
    {
      name: 'GitHub',
